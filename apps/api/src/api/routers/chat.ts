...
import { ChatSendMessageService } from "../../services/chat-send-message-service";
...
const chatSendMessageService = new ChatSendMessageService();
...
export const chatRouter = router({
  ...
  sendMessage: publicProcedure
    ...
    .mutation(async ({ input }) => {
      return await chatSendMessageService.sendMessage(input);
    }),
