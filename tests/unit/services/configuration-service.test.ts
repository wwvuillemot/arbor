...
describe("ConfigurationService", () => {
  ...
  describe("getConfiguration", () => {
    ...
    it("should return stored value when configuration is set", async () => {
      ...
      expect(databaseUrl).toBe(
        "postgres://custom:custom@custom-host:5432/custom",
      );
    });
  ...
  describe("setConfiguration", () => {
    it("should store configuration value", async () => {
      await configService.setConfiguration(
        "DATABASE_URL",
        "postgres://new:new@new-host:5432/new",
      );
    ...
    it("should update existing configuration", async () => {
      ...
      await configService.setConfiguration(
        "DATABASE_URL",
        "postgres://updated:updated@updated-host:5432/updated",
      );
  ...
  describe("resetConfiguration", () => {
    it("should delete configuration and return to default", async () => {
      ...
      await configService.setConfiguration(
        "DATABASE_URL",
        "postgres://custom:custom@custom:5432/custom",
      );
